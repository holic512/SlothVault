...
ALTER TABLE "collections_project_version" ADD COLUMN "document_revision" INTEGER NOT NULL DEFAULT 0;
ALTER TABLE "collections_project_version" ADD COLUMN "release_id" TEXT;
ALTER TABLE "collections_project_version" ADD COLUMN "release_hash" TEXT;
ALTER TABLE "collections_project_version" ADD COLUMN "manifest_version" INTEGER;
ALTER TABLE "collections_project_version" ADD COLUMN "published_at" DATETIME;
