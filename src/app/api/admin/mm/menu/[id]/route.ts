...
import handler0 from '../../../../../../../server/api/admin/mm/menu/[id].put'
import handler1 from '../../../../../../../server/api/admin/mm/menu/[id].get'
import handler2 from '../../../../../../../server/api/admin/mm/menu/[id].delete'
