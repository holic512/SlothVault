 ...
 * @logic Authenticate, validate project/wallet/metadata input, reserve provisional capacity under a PostgreSQL row lock without claiming a final leaf, optionally publish project media, persist expiry context, and return an opaque five-minute session.
...
export const POST = defineRoute(async (request) => {
  ...
  return apiOk(
    await prepareCnft({ ...body, projectId: BigInt(body.projectId) }),
