...
/* Fallback for title color if gradient fails or simple theme */
.dark .login-title {
...
.sloth-btn-primary:hover:not(:disabled) {
  background: var(--sloth-primary-hover, var(--sloth-primary)); /* Fallback */
